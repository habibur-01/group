    ...
    <div>
      <footer className="footer bg-[#16171b] text-white p-16">
        <div>
          ...
          <p>Domain Registration,Web Hosting, Web design & <br/>Developed by Duronto Web Ltd</p>
        ...
        <nav>
          ...
          <a className="link link-hover text-base">Duronto Web</a>
          <a className="link link-hover text-base">Duronto Host</a>
          <a className="link link-hover text-base">Duronto Network</a>
        </nav>
        <nav>
          <h6 className="footer-title tracking-wider">Company Owned</h6>
          <a className="link link-hover text-base">Company Name1</a>
          <a className="link link-hover text-base">Company Name2</a>
          <a className="link link-hover text-base">Company Name3</a>
        </nav>
        <nav>
      ...
      <div className="w-full h-16 text-[#FFFFFF] text-base flex justify-center items-center bg-[#24262c]">
        <h1>Copyright &copy; 2022 <span>Duronto Group</span></h1>
      </div>
    </div>
  );
};
